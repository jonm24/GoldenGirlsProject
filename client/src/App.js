  ...
  return (
    <div className="App">
      <div id="app-container">
        <h1 onClick={() => setFriendsPage(false)} style={{ cursor: "pointer" }}>
          KickBack
        </h1>
        {isLoading ? (
    ...
    <div className="flex user-container">
      <div className="welcome">
        ...
        <div onClick={() => setFriendsPage(true)} style={{ paddingLeft: "10px", paddingTop: "5px" }}>
          <img
            alt="friends"
            src="https://img.icons8.com/external-flatart-icons-outline-flatarticons/40/000000/external-contacts-twitter-flatart-icons-outline-flatarticons.png"
          />
        </div>
        <LogoutButton />
      </div>
